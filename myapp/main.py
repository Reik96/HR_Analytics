...
def main():
    ...
    if menu_action == "Predictions":
        ...
        gs_button = st.button("Store Data in Google Spreadsheets")
        if gs_button == True:
            try:
                st.write("Data stored in Google Spreadsheets")
                data_storing_gs(df_conc)
            except Exception:
                pass
    ...
    if menu_action == "Visualizations":
        ...
        dashboard_button = st.button("Update Dashboard")

        if dashboard_button == True:
            st.write("Yupppp")
